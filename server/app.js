...
app.use(cors({
  origin:"http://passwordmanagerapp.s3-website.eu-north-1.amazonaws.com",
  credentials:true,
...
app.use(function(req, res, next) {
  ...
  res.header('Access-Control-Allow-Origin', "http://passwordmanagerapp.s3-website.eu-north-1.amazonaws.com");
