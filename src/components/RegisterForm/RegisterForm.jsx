...
const RegisterForm = (props)=>{
    ...
    const createUser = async (username,email,authKey)=>{
        ...
        let res = await fetch(`${process.env.REACT_APP_SERVER_ENDPOINT}/users/create/`,{
            method:"POST",
    ...
    const checkIfEmailExists = async (email)=>{
        ...
        let response = await fetch(`${process.env.REACT_APP_SERVER_ENDPOINT}/users/checkUserEmail?email=${email}`)
    ...
    const checkIfUsernameExists = async (username)=>{
        ...
        let response = await fetch(`${process.env.REACT_APP_SERVER_ENDPOINT}/users/checkUsername?username=${username}`)
        response = await response.json()
