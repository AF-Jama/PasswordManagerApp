...
const RegisterForm = (props)=>{
    ...
    const createUser = async (username,email,authKey)=>{
        ...
        let res = await fetch('http://18.212.164.56:5050/users/create/',{
            method:"POST",
    ...
    const checkIfEmailExists = async (email)=>{
        ...
        let response = await fetch(`http://18.212.164.56:5050/users/checkUserEmail?email=${email}`)
    ...
    const checkIfUsernameExists = async (username)=>{
        ...
        let response = await fetch(`http://18.212.164.56:5050/users/checkUsername?username=${username}`)
        response = await response.json()
